...
export default function Modal({setPic, pic,setter,user}) {
            ...
            <div className="relative w-auto my-6 mx-auto max-w-3xl">
              ...
              <div className="border-0 rounded-lg shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="relative p-6 flex flex-wrap">
                  {avatarList.map((el,index)=>   <img
    src={el}
    onClick={() => {
      setPic(index + 1);
      setter({
        ...user,
        imageTeacherKey: index + 1,
      });
    }}
    className={`rounded-full ${pic - 1 === index && 'border-4 border-solid border-sky-500'}`}
    cursor="pointer"
    width={54}
  />)}
                </div>
